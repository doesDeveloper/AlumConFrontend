...
<form on:submit|preventDefault={handleRegister}>
  <fieldset>
    ...
    <Field label="Password*" id="password" type="password" bind:value={formData.password} error={errors.password} />
  </fieldset>

  <fieldset>
    <legend>Personal Details</legend>
    <Field label="First Name*" id="firstName" bind:value={formData.firstName} error={errors.firstName} />
    <Field label="Last Name" id="lastName" bind:value={formData.lastName} />
    <Field label="Email*" id="email" type="email" bind:value={formData.email} error={errors.email} />
